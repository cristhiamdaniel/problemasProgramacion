...
int main() {
    ...
    // Guardar el mensaje encriptado en un archivo llamado "encriptado.txt"
    ofstream archivo_salida("encriptado.txt"); // Abrir el archivo de salida
    if (!archivo_salida.is_open()) { // Verificar si se pudo abrir el archivo
        cout << "No se pudo abrir el archivo de salida." << endl;
        return 1;
    }
    archivo_salida << mensaje; // Escribir el mensaje encriptado en el archivo
    archivo_salida.close(); // Cerrar el archivo de salida
